...
public class UpdateVideoUseCaseTest extends UseCaseTest {
    ...
    public void givenAValidCommand_whenCallsCreateVideo_shouldReturnVideoId() {
        // given
        final var aVideos = Fixture.Videos.systemDesign();
        ...
        when(videoGateway.findById(any()))
                .thenReturn(Optional.of(Video.with(aVideos)));
        ...
        verify(videoGateway).update(argThat(aVideo ->
                Objects.equals(expectedTitle, aVideo.getTitle()) &&
                        ...
                        Objects.equals(aVideos.getCreatedAt(), aVideo.getCreatedAt()) &&
                        aVideos.getUpdatedAt().isBefore(aVideo.getUpdatedAt())
        ));
    }
    ...
    public void givenAValidCommand_whenCallsUpdateVideoAndSomeCategoriesDoesNotExists_shouldReturnDomainException() {
        ...
        final var expectedGenres = Set.of(Fixture.Genres.tech().getId());
        final var expectedMembers = Set.of(Fixture.CastMembers.jonas().getId());
        final Resource expectedVideo = null;
        final Resource expectedTrailer = null;
        final Resource expectedBanner = null;
        final Resource expectedThumb = null;
    ...
    public void givenAValidCommand_whenCallsUpdateVideoAndSomeCastMembersDoesNotExists_shouldReturnDomainException() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();
        final var mariaId = Fixture.CastMembers.maria().getId();

        final var expectedErrorMessage = "Some cast members could not be found: %s".formatted(mariaId.getValue());
        final var expectedErrorCount = 1;
        ...
        final var expectedCategories = Set.of(Fixture.Categories.aulas().getId());
        final var expectedGenres = Set.of(Fixture.Genres.tech().getId());
        final var expectedMembers = Set.of(mariaId);
        final Resource expectedVideo = null;
        final Resource expectedTrailer = null;
        final Resource expectedBanner = null;
        final Resource expectedThumb = null;
    ...
    public void givenAValidCommand_whenCallsUpdateVideoThrowsException_shouldCallClearResources() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();
        final var expectedErrorMessage = "An error on update video was observed [videoId:%s]";
        ...
        // then
        Assertions.assertNotNull(actualResult);
        Assertions.assertFalse(actualResult.getMessage().startsWith(expectedErrorMessage));
