...
import org.jonasribeiro.admin.catalogo.application.video.CreateVideoCommand;
import org.jonasribeiro.admin.catalogo.application.video.DefaultCreateVideoUseCase;
...
public class CreateVideoUseCaseTest extends UseCaseTest {
    ...
    public void givenAValidCommand_whenCallsCreateVideoAndSomeCastMembersDoesNotExists_shouldReturnDomainException() {
        // given
        final var wesleyId = Fixture.CastMembers.jonas().getId();
