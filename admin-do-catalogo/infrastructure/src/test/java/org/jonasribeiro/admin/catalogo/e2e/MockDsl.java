...
public interface MockDsl {
    ...
    default ResultActions deleteCategory(final Identifier anId) throws Exception {
    ...
    default ResultActions updateCategory(final Identifier aName, final UpdateCategoryRequest aRequest) throws Exception {
        return this.update("/categories/", aName, aRequest);
    }

    default ResultActions updateAGenre(final Identifier aName, final UpdateGenreRequest aRequest) throws Exception {
