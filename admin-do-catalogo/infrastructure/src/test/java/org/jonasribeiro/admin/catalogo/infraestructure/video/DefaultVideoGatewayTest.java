...
public class DefaultVideoGatewayTest {
   ...
   // private Genre business;
    ...
    @BeforeEach
    public void setUp() {
        jonas = castMemberGateway.create(Fixture.CastMembers.jonas());
        maria = castMemberGateway.create(Fixture.CastMembers.maria());
    ...
    public void givenAValidVideo_whenCallsCreate_shouldPersistIt() {
        ...
        // Verifica Optionals antes de acessar
        ...
        final var persistedVideoOpt = videoRepository.findById(actualVideo.getId().getValue());
        Assertions.assertTrue(persistedVideoOpt.isPresent());
        final var persistedVideo = persistedVideoOpt.get();
        ...
        Assertions.assertEquals(expectedGenres, persistedVideo.getGenreID());
        Assertions.assertEquals(expectedMembers, persistedVideo.getCastMemberID());
        Assertions.assertTrue(persistedVideo.getVideo() != null);
        Assertions.assertEquals(expectedVideo.name(), persistedVideo.getVideo().getName());
        Assertions.assertTrue(persistedVideo.getTrailer() != null);
        Assertions.assertEquals(expectedTrailer.name(), persistedVideo.getTrailer().getName());
        Assertions.assertTrue(persistedVideo.getBanner() != null);
        Assertions.assertEquals(expectedBanner.name(), persistedVideo.getBanner().getName());
        Assertions.assertTrue(persistedVideo.getThumbnail() != null);
        Assertions.assertEquals(expectedThumb.name(), persistedVideo.getThumbnail().getName());
        Assertions.assertTrue(persistedVideo.getThumbnailHalf() != null);
    ...
    private void mockVideos() {
        videoGateway.create(Video.newVideo(
                ...
                Set.of(aulas.getId()),
                Set.of(tech.getId()),
                Set.of(jonas.getId(), maria.getId())
        ));
