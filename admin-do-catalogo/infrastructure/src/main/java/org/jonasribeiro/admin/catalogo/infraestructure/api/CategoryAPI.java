...
public interface CategoryAPI {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "402",
                    description = "Validation error, check the request body for more details"),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "422",
                    description = "A invalid parameter was received, check the request parameters for more details"),
            @ApiResponse(responseCode = "404",
                    description = "No categories found for the given parameters"),
            @ApiResponse(responseCode = "400",
                    description = "Bad request, check the request parameters for more details"),
            @ApiResponse(responseCode = "401",
                    description = "Unauthorized, you need to be authenticated to access this resource"),
