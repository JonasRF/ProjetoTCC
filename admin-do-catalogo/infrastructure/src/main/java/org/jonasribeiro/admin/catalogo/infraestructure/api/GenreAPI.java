...
public interface GenreAPI {
    ...
    @GetMapping
    @Operation(summary = "List genre paginated")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Genre listed successfully"),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Genre not found with the given identifier"),
            @ApiResponse(responseCode = "500", description = "An internal server error occurred, please try again later")
