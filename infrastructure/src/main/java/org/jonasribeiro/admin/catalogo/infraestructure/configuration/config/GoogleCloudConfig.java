...
import org.jonasribeiro.admin.catalogo.infraestructure.configuration.properties.google.GoogleCloudProperties;
...
public class GoogleCloudConfig {
    ...
    @Bean
    public Credentials credentials(final GoogleCloudProperties properties) throws IOException {
        final var jsonContent = Base64.getDecoder()
                .decode(Objects.requireNonNull(properties.getCredentials()));
